...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li><a href="contactUs.php">Data Contact Us</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <div class="container-fluid" style="padding-top: 40px;">    
    <div class="row content">
      <table class="table">
        <h2 align="center">Data Contact Us</h2>
        ...
        <tbody>
          ...
          if($result->num_rows > 0){
            ...
            <tr>
              ...
              <td>
                <a onclick="return confirm('Anda yakin menghapus record ini?')" class="btn btn-danger" href="prosesDeleteContactUs.php?id=<?=$row['id']?>">Delete</a>
              </td>
            </tr>
            <?php
          }
